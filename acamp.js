...
if(acampamento == 0) {
    ...
    FogueiraCord = [ '12', '24', '33', '56', '62', '77'];
    madeiraCord = [ '25', '71'];
...
if(terrainType == "FC3P1M")
    
    {

        var bit = document.getElementById("Ax1y1")
        bit.style.backgroundColor = "rgb(154, 207, 238)";
        var bit = document.getElementById("Ax1y2")
        bit.style.backgroundColor = "rgb(154, 207, 238)";
        var bit = document.getElementById("Ax1y3")
        bit.style.backgroundColor = "rgb(154, 207, 238)"
...
if(terrainType == "T4P0M") //aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
    
    {
        ...
        bit.style.backgroundColor = "rgb(116, 114, 146)";
        var bit = document.getElementById("Ax1y2")
        bit.style.backgroundColor = "rgb(232, 173, 102)";
        var bit = document.getElementById("Ax1y3")
        bit.style.backgroundColor = "rgb(232, 173, 102)"
        var bit = document.getElementById("Ax1y4")
        bit.style.backgroundColor = "rgb(232, 173, 102)";
...
if(terrainType == "T3P0M")
    ...
    var bit = document.getElementById("Ax4y5")
    bit.style.backgroundColor = "rgb(255, 140, 18)";

    var bit = document.getElementById("Ax5y4")
    bit.style.backgroundColor = "rgb(222, 223, 251)";
    ...
    bit.style.display = "block";
        ...
        alert("Você não pode criar seu acampamento aqui!")
        ...
        alert("você ja tem um acampamento")
